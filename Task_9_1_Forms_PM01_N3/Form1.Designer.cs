namespace Task_9_1_Forms_PM01_N3
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Введите число, которое будет использоваться для определения нужных чисел";
			// 
			// textBox2
			// 
			...
			this.label3.Text = "Выведенные числа";
			// 
			// textBox3
			// 
			...
			this.textBox3.Size = new System.Drawing.Size(515, 155);
